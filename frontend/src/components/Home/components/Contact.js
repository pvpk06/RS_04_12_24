...
const Contact = () => {
  ...
  return (
    <div className='p-1'>
      <Helmet>
        <title>Contact Us - Get in Touch with RamanaSoft</title>
        <meta
          name="description"
          content="Reach out to RamanaSoft for inquiries, services, or support. Contact us via email, phone, or visit our office."
        />
        <meta property="og:title" content="Contact RamanaSoft" />
        <meta
          property="og:description"
          content="Contact RamanaSoft Consulting Services for support, inquiries, or collaborations."
        />
        <meta property="og:url" content="https://ramanasoft.com/contact" />
        <meta name="twitter:title" content="Contact Us - RamanaSoft" />
        <meta
          name="twitter:description"
          content="Get in touch with RamanaSoft for inquiries, services, or collaborations."
        />
      </Helmet>
