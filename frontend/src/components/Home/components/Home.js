              ...
              <div style={{ position: 'relative', zIndex: 0, display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                >
                  ...
                  {hover1 && (
                    ...
                    >
                      QT NEXT is a learning platform that offers courses, assessments, and certifications in diverse tech fields. It emphasizes practical learning through live classes and hands-on training to prepare users for careers in tech.</div>
                  )}
                </div>
