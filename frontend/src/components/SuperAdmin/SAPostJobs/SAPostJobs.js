...
const validationSchema = Yup.object().shape({
  ...
  jobTitle: Yup.string()
    ...
    .min(10, 'Job Title must be at least 1 character')
              ...
              <Col>
                ...
                <Row className="mb-3">
                  ...
                  <Col>
                    ...
                    <Field name="openings" type="number" min="1" className={`form-control ${touched.openings && errors.openings ? 'is-invalid' : ''}`} placeholder="Enter Number of Openings" />
